...
#------------------------------
    ...
    clawdata.lower[0] = 365809
    clawdata.upper[0] = 383350

    clawdata.lower[1] = 3357812
    clawdata.upper[1] = 3376863
...
#-------------------
    ...
    topo_path = os.path.join(os.getcwd(), "data", "ch_new_elev_converted.nc")
